...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="flex md:flex-row flex-wrap xs:flex-col md:gap-20 lg:gap-0 text-center md:pt-32 xs:pt-20 xs:px-4 h-[90%]"
    >
      ...
      <div className="xs:6/12 md:8/12 xs:mx-auto lg:ml-12">
        <h1 className="text-7xl sm:text-8xl font-bold text-gray-300">José</h1>
        <h1 className="text-indigo-500 xs:text-6xl sm:text-8xl font-bold">
          Domene
        </h1>
        <h3 className="text-2xl pt-3 text-gray-300 ">
          Desarollador Web 🖥️, apasionado por la tecnología y la programación. 
        </h3>
        <h3 className="text-2xl pt-3 text-gray-300 mb-8 ">
